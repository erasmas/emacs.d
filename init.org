...
* About
  ...
  git clone https://github.com/larstvei/emacs.d
  #+END_SRC
   ...
   (let* ((package--builtins nil)
          (packages
           '(auto-compile         ; automatically compile Emacs Lisp libraries
             ...
             material-theme       ; Emacs Theme inspired by the Google Material Design
...
** Flyspell
   ...
   the languages in ISPELL-LANGUAGES when invoked."
     (lexical-let ((ispell-languages '#1=("american" "ukrainian" . #1#)))
